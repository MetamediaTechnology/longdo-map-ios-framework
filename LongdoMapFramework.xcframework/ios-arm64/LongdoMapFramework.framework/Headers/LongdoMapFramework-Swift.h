...
#ifndef LONGDOMAPFRAMEWORK_SWIFT_H
#define LONGDOMAPFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LongdoMapFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Creates Longdo Map view and initializes it with the specified frame.
